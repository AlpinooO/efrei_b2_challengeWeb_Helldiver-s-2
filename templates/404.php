...
<section class="container-404">
    ...
    <div class="message-404">
        ...
        <div class="url-404">Page recherché : <?php
...
?>
        ...
        <p>Nous sommes désolés mais la page que vous recherchez n'existe pas. Veuillez vérifier l'URL ou consulter notre <a href="/">accueil</a>.</p>
    </div>
</section>
</body>
</html>