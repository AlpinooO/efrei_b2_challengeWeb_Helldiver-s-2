...
<div class="main-container" x-cloak x-data="{ tab: 'Automates' }">
        <div class="species-container">
            ...
            <div>
                <div class="description-faction" x-show="tab === 'Automates'">
                    <img src="https://static.wikia.nocookie.net/helldivers_gamepedia/images/7/72/AutomatonoutposticonHD.png"/> Robots Cyborgs communiste
                </div>
        ...
        <div>  
            <div x-show="tab === 'Automates'">
                <h2 class="species-title">Enemies de la démocracie</h2>
                <div class="species-container" x-cloak x-data="{ tabTypes: 'Auto1' }">
                    <ul class="tab-list">
                        <li class="tab-item">
                            <a class="tab-link tab-link:hover"
            ...
            <div x-show="tab === 'Terminides'">
                <h2 class="species-title">Enemies de la démocracie</h2>
                <div class="species-container" x-cloak x-data="{ tabTypes: 'Termi1' }">
                    <ul class="tab-list">
                        <li class="tab-item">
                            <a class="tab-link tab-link:hover"
            ...
            <div x-show="tab === 'Illuminates'">
                <h2 class="species-title">Enemies de la démocracie</h2>
                <div class="species-container" x-cloak x-data="{ tabTypes: 'Illumi1' }">
                    <ul class="tab-list">
                        <li class="tab-item">
                            <a class="tab-link tab-link:hover"
